...
public class TileEntityBeaconSPC extends TileEntityLockable implements ITickable, ISidedInventory
{
	...
	public static final Potion[][] EFFECTS_LIST = new Potion[][] {{MobEffects.SPEED, MobEffects.HASTE}, {MobEffects.RESISTANCE, MobEffects.JUMP_BOOST}, {MobEffects.STRENGTH}, {MobEffects.INSTANT_HEALTH}};
private static final Set<Potion> VALID_EFFECTS = Sets.<Potion>newHashSet();
/** A list of beam segments for this beacon */
private final List<TileEntityBeaconSPC.BeamSegment> beamSegments = Lists.<TileEntityBeaconSPC.BeamSegment>newArrayList();
...
private void updateSegmentColors()
{
	...
	TileEntityBeaconSPC.BeamSegment tileentitybeacon$beamsegment = new TileEntityBeaconSPC.BeamSegment(EnumDyeColor.WHITE.getColorComponentValues());
	...
	{
		tileentitybeacon$beamsegment = new TileEntityBeaconSPC.BeamSegment(afloat);
		this.beamSegments.add(tileentitybeacon$beamsegment);
	}
...
@SideOnly(Side.CLIENT)
public List<TileEntityBeaconSPC.BeamSegment> getBeamSegments()
{
