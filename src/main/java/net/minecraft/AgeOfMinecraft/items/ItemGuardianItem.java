...
public class ItemGuardianItem
extends ItemTierItem
{
	public ItemGuardianItem(int tier)
	{
		super(3);
		setRegistryName("guardian");
		setUnlocalizedName("guardian");
		itemTier = 3;
	}
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		EntityGuardian entityliving = new EntityGuardian(worldIn);
