...
public class ItemMooshroomItem
extends ItemTierItem
{
	public ItemMooshroomItem(int tier)
	{
		super(0);
		setRegistryName("mooshroom");
		setUnlocalizedName("mooshroom");
		itemTier = 0;
	}
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		EntityMooshroom entityliving = new EntityMooshroom(worldIn);
