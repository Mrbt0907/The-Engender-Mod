...
public class ItemParrotItem
extends ItemTierItem
{
	public ItemParrotItem(int tier)
	{
		super(0);
		setRegistryName("parrot");
		setUnlocalizedName("parrot");
		itemTier = 0;
	}
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		EntityParrot entityliving = new EntityParrot(worldIn);
