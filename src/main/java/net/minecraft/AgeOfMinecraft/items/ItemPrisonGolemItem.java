...
public class ItemPrisonGolemItem
extends ItemTierItem
{
	public ItemPrisonGolemItem(int tier)
	{
		super(4);
		setRegistryName("prisongolem");
		setUnlocalizedName("prisongolem");
		itemTier = 4;
	}
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		EntityPrisonGolem entityliving = new EntityPrisonGolem(worldIn);
