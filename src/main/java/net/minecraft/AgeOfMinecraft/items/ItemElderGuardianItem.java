...
public class ItemElderGuardianItem
extends ItemTierItem
{
	public ItemElderGuardianItem(int tier)
	{
		super(4);
		setRegistryName("elderguardian");
		setUnlocalizedName("elderguardian");
		itemTier = 4;
	}
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		EntityElderGuardian entityliving = new EntityElderGuardian(worldIn);
