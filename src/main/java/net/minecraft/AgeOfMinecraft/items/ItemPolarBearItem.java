...
public class ItemPolarBearItem
extends ItemTierItem
{
	public ItemPolarBearItem(int tier)
	{
		super(2);
		setRegistryName("polarbear");
		setUnlocalizedName("polarbear");
		itemTier = 2;
	}
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		EntityPolarBear entityliving = new EntityPolarBear(worldIn);
