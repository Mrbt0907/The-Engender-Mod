...
public class ItemPrisonSlimeItem
extends ItemTierItem
{
	public ItemPrisonSlimeItem(int tier)
	{
		super(2);
		setRegistryName("prisonslime");
		setUnlocalizedName("prisonslime");
		itemTier = 2;
	}
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		EntityPrisonSlime entityliving = new EntityPrisonSlime(worldIn);
