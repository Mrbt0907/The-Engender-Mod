...
public class ItemShulkerItem
extends ItemTierItem
{
	public ItemShulkerItem(int tier)
	{
		super(3);
		setRegistryName("shulker");
		setUnlocalizedName("shulker");
		itemTier = 3;
	}
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		EntityShulker entityliving = new EntityShulker(worldIn);
