...
public class ItemIronGolemItem
extends ItemTierItem
{
	public ItemIronGolemItem(int tier)
	{
		super(4);
		setRegistryName("irongolem");
		setUnlocalizedName("irongolem");
		itemTier = 4;
	}
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		EntityIronGolem entityliving = new EntityIronGolem(worldIn);
