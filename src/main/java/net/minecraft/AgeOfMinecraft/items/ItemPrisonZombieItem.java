...
public class ItemPrisonZombieItem
extends ItemTierItem
{
	public ItemPrisonZombieItem(int tier)
	{
		super(3);
		setRegistryName("prisonzombie");
		setUnlocalizedName("prisonzombie");
		itemTier = 3;
	}
