...
public class ItemGhastherItem
extends ItemTierItem
{
	public ItemGhastherItem(int tier)
	{
		super(4);
		setRegistryName("ghasther");
		setUnlocalizedName("ghasther");
		itemTier = 4;
	}
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		EntityGhasther entityliving = new EntityGhasther(worldIn);
