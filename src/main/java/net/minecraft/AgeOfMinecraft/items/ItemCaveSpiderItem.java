...
public class ItemCaveSpiderItem
extends ItemTierItem
{
	public ItemCaveSpiderItem(int tier)
	{
		super(3);
		setRegistryName("cavespider");
		setUnlocalizedName("cavespider");
		itemTier = 3;
	}
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		EntityCaveSpider entityliving = new EntityCaveSpider(worldIn);
