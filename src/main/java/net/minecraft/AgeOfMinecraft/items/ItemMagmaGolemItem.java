...
public class ItemMagmaGolemItem
extends ItemTierItem
{
	public ItemMagmaGolemItem(int tier)
	{
		super(4);
		setRegistryName("magmagolem");
		setUnlocalizedName("magmagolem");
		itemTier = 4;
	}
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		EntityMagmaGolem entityliving = new EntityMagmaGolem(worldIn);
