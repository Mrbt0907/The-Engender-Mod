...
public class ItemWitherItem
extends ItemTierItem
{
	public ItemWitherItem(int tier)
	{
		super(4);
		setRegistryName("witherboss");
		setUnlocalizedName("witherboss");
		itemTier = 4;
	}
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		EntityWither entityliving = new EntityWither(worldIn);
