...
public class ItemKillerBunnyItem
extends ItemTierItem
{
	public ItemKillerBunnyItem(int tier)
	{
		super(3);
		setRegistryName("killerbunny");
		setUnlocalizedName("killerbunny");
		itemTier = 3;
	}
