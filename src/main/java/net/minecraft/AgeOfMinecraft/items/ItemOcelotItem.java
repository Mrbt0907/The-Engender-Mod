...
public class ItemOcelotItem
extends ItemTierItem
{
	public ItemOcelotItem(int tier)
	{
		super(0);
		setRegistryName("ozelot");
		setUnlocalizedName("ozelot");
		itemTier = 0;
	}
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		EntityOcelot entityliving = new EntityOcelot(worldIn);
