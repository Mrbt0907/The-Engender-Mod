...
public class ItemIceGolemItem
extends ItemTierItem
{
	public ItemIceGolemItem(int tier)
	{
		super(4);
		setRegistryName("icegolem");
		setUnlocalizedName("icegolem");
		itemTier = 4;
	}
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		EntityIceGolem entityliving = new EntityIceGolem(worldIn);
