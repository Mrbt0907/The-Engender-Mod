...
public class ItemIceSpiderItem
extends ItemTierItem
{
	public ItemIceSpiderItem(int tier)
	{
		super(3);
		setRegistryName("icespider");
		setUnlocalizedName("icespider");
		itemTier = 3;
	}
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		EntityIceSpider entityliving = new EntityIceSpider(worldIn);
