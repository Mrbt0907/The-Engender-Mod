...
public class ItemIllusionerItem
extends ItemTierItem
{
	public ItemIllusionerItem(int tier)
	{
		super(4);
		setRegistryName("illusioner");
		setUnlocalizedName("illusioner");
		itemTier = 4;
	}
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		EntityIllusioner entityliving = new EntityIllusioner(worldIn);
