...
public class ItemMagmaCubeItem
extends ItemTierItem
{
	public ItemMagmaCubeItem(int tier)
	{
		super(2);
		setRegistryName("magmacube");
		setUnlocalizedName("magmacube");
		itemTier = 2;
	}
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		EntityMagmaCube entityliving = new EntityMagmaCube(worldIn);
