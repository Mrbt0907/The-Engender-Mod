...
public class ItemVindicatorItem
extends ItemTierItem
{
	public ItemVindicatorItem(int tier)
	{
		super(3);
		setRegistryName("vindicator");
		setUnlocalizedName("vindicator");
		itemTier = 3;
	}
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		EntityVindicator entityliving = new EntityVindicator(worldIn);
