...
public class ModelWitherStormTentecleDevourer
extends ModelBase
{
	...
	public ModelWitherStormTentecleDevourer()
	{
		...
		this.TentecleTip3.addBox(-6.0F, -128.0F, -6.0F, 12, 128, 12, 0.0F);
	...
	public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
	{
		...
		this.TentecleBase1.rotateAngleY = (0.4F * MathHelper.sin(ageInTicks * 0.031200068F + 3.9F));
		this.TentecleBase2.rotateAngleX = 0.4F;
		this.TentecleBase3.rotateAngleX = -0.1F;
		this.TentecleBase4.rotateAngleX = -0.1F;
		this.TentecleMiddle1.rotateAngleX = -0.1F;
		this.TentecleMiddle2.rotateAngleX = -0.1F;
		this.TentecleMiddle3.rotateAngleX = -0.1F;
		this.TentecleTip1.rotateAngleX = -0.1F;
		this.TentecleTip2.rotateAngleX = -0.1F;
		this.TentecleTip3.rotateAngleX = -0.1F;
		this.TentecleBase1.rotateAngleZ = (0.5F * MathHelper.sin(ageInTicks * 0.02F + 3.9F));
		this.TentecleBase2.rotateAngleZ = (0.5F * MathHelper.sin(ageInTicks * 0.02F + 3.6F));
		this.TentecleBase3.rotateAngleZ = (0.25F * MathHelper.sin(ageInTicks * 0.02F + 3.3F));
		this.TentecleBase4.rotateAngleZ = (0.2F * MathHelper.sin(ageInTicks * 0.02F + 3.0F));
		this.TentecleMiddle1.rotateAngleZ = (0.15F * MathHelper.sin(ageInTicks * 0.02F + 2.8F));
		this.TentecleMiddle2.rotateAngleZ = (0.15F * MathHelper.sin(ageInTicks * 0.02F + 2.4F));
		this.TentecleMiddle3.rotateAngleZ = (0.15F * MathHelper.sin(ageInTicks * 0.02F + 2.0F));
		this.TentecleTip1.rotateAngleZ = (0.1F * MathHelper.sin(ageInTicks * 0.02F + 1.8F));
		this.TentecleTip2.rotateAngleZ = (0.1F * MathHelper.sin(ageInTicks * 0.02F + 1.4F));
		this.TentecleTip3.rotateAngleZ = (0.2F * MathHelper.sin(ageInTicks * 0.02F + 1.0F));
		this.TentecleBase1.rotateAngleX = (0.3F * MathHelper.sin(ageInTicks * 0.05F + 1.0F));
		EntityWitherStormTentacleDevourer entitytentacle = (EntityWitherStormTentacleDevourer)entityIn;
