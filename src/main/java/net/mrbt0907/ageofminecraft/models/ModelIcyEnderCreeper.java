...
public class ModelIcyEnderCreeper
extends ModelBiped
{
	public boolean isCarrying;
	public boolean isAttacking;
	public ModelIcyEnderCreeper()
	{
		this(0F);
	}
	public ModelIcyEnderCreeper(float scale)
	{
		super(0.0F, -14.0F, 64, 32);
		float f = -14.0F;
		this.bipedHeadwear = new ModelRenderer(this, 0, 16);
		this.bipedHeadwear.addBox(-4.0F, -8.0F, -4.0F, 8, 8, 8, scale - 0.1F);
	...
	public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
	{
		...
		EntityIcyEnderCreeper entity = (EntityIcyEnderCreeper)entityIn;
		this.isAttacking = entity.isArmsRaised();
		this.isCarrying = entity.getControllingPassenger() != null;
		this.isChild = entity.isChild();
		this.isSneak = entity.isSneaking();
		
		this.bipedHeadwear.rotationPointX = 0F;
		
		if (isAttacking)
		{
			this.bipedHead.rotationPointY -= 4.5F - MathHelper.sin(this.bipedHead.rotateAngleX);
			this.bipedHeadwear.rotationPointZ = MathHelper.sin(this.bipedHead.rotateAngleX) * 4.5F;
		}
