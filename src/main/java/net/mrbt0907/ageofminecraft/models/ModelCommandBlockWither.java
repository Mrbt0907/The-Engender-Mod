...
extends ModelBase
{
	...
	public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_)
	{
		...
		EntityWitherStorm wither = (EntityWitherStorm)p_78087_7_;
		...
		{
			EntityWitherStorm entitywither = (EntityWitherStorm)p_78086_1_;
			this.RightHead.rotateAngleY = ((entitywither.getHeadYRotation(1) - p_78086_1_.renderYawOffset) / 57.295776F);
			this.RightHead.rotateAngleX = (entitywither.getHeadXRotation(1) / 57.295776F);
			this.LeftHead.rotateAngleY = ((entitywither.getHeadYRotation(1) - p_78086_1_.renderYawOffset) / 57.295776F);
			this.LeftHead.rotateAngleX = (entitywither.getHeadXRotation(1) / 57.295776F);
		}
	}
