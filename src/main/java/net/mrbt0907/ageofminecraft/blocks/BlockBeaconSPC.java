...
import net.mrbt0907.ageofminecraft.registry.CreativeTabRegistry;
...
public class BlockBeaconSPC extends BlockContainer
{
	...
	*/
	...
	{
		return new TileEntityBeaconSPC();
	}
	...
	*/
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		else
		{
			...
			{
				playerIn.displayGUIChest((TileEntityBeaconSPC)tileentity);
	...
	*/
	public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
	{
		...
		if (stack.hasDisplayName())
		{
			...
			if (tileentity instanceof TileEntityBeaconSPC)
			{
				((TileEntityBeaconSPC)tileentity).setName(stack.getDisplayName());
			}
		}
	}
