...
import net.mrbt0907.ageofminecraft.models.ModelIronGolem;
@SideOnly(Side.CLIENT)

public class RenderMagmaGolem extends RenderLiving<EntityMagmaGolem>
{
	private static final ResourceLocation iceGolemTextures = new ResourceLocation("ageofminecraft", "textures/entities/magma_golem.png");
	private static ModelIronGolem regularmodel = new ModelIronGolem();
	
	public RenderMagmaGolem(RenderManager p_i46133_1_)
	{
	...
	protected ResourceLocation getEntityTexture(EntityMagmaGolem entity)
	{
		return iceGolemTextures;
	}

	protected void preRenderCallback(EntityMagmaGolem entitylivingbaseIn, float partialTickTime)
	{
	...
	protected void applyRotations(EntityMagmaGolem entityLiving, float p_77043_2_, float p_77043_3_, float partialTicks)
	{
	...
	*/
	public void doRender(EntityMagmaGolem entity, double x, double y, double z, float entityYaw, float partialTicks)
	{
	...
	protected boolean isVisible(EntityMagmaGolem entity)
	{
