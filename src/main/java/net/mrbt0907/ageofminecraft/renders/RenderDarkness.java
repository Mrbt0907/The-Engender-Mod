...
import net.mrbt0907.ageofminecraft.models.ModelDarkness;
...
public class RenderDarkness extends RenderLiving<EntityDarkness>
{
	...
	public void doRender(EntityDarkness entity, double x, double y, double z, float entityYaw, float partialTicks)
	{
		...
		{
			net.mrbt0907.ageofminecraft.util.mrbtutil.Maths.Vec3 startPos = lesserBeam.getStartPos();
			net.mrbt0907.ageofminecraft.util.mrbtutil.Maths.Vec3 endPos = lesserBeam.getEndPos();
