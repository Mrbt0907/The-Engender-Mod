	...
	*/
	...
	private void applySplash(RayTraceResult p_190543_1_, List<PotionEffect> p_190543_2_)
	{
		...
		if (!list.isEmpty())
		{
			...
			{
				return p_190544_0_ instanceof EntityEnderman || p_190544_0_ instanceof EntityBlaze || p_190544_0_ instanceof net.mrbt0907.ageofminecraft.entity.tier4.EntityBlaze || p_190544_0_ instanceof net.mrbt0907.ageofminecraft.entity.tier4.EntityEnderman;
			}
		}