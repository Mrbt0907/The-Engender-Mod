...
protected void func_184567_a(RayTraceResult result)
{
	...
	{
		if ((!this.field_184570_a.isOnSameTeam((EntityLivingBase)result.entityHit) || (field_184570_a instanceof net.mrbt0907.ageofminecraft.entity.tier4.EntityShulker && ((net.mrbt0907.ageofminecraft.entity.tier4.EntityShulker)field_184570_a).isPositiveShulker() && this.field_184570_a.isOnSameTeam((EntityLivingBase)result.entityHit))) && (this.field_184570_a != null))
		{
			...
			((net.mrbt0907.ageofminecraft.entity.tier4.EntityShulker)field_184570_a).inflictShulkerEffects((EntityLivingBase)result.entityHit);
