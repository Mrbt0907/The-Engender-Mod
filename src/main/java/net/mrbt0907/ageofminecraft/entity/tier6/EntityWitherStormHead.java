package net.mrbt0907.ageofminecraft.entity.tier6;
...
import net.mrbt0907.ageofminecraft.entity.Flying;
import net.mrbt0907.ageofminecraft.entity.Massive;
import net.mrbt0907.ageofminecraft.entity.Undead;
import net.mrbt0907.ageofminecraft.entity.ai.EntityAIAttackRangedAlly;
import net.mrbt0907.ageofminecraft.entity.other.BeamHitbox;
import net.mrbt0907.ageofminecraft.entity.other.IBeamHitboxHandler;
import net.mrbt0907.ageofminecraft.entity.tier5.EntityEnderDragon;
import net.mrbt0907.ageofminecraft.entity.tier5.EntityGhasther;
...
import net.mrbt0907.ageofminecraft.util.mrbtutil.chunk.MobChunkLoader;
		...
		else
		{
			...
			if (!isInvisible() && target != null)
			{
				...
				if (target.getHealth() > 0.0F && !(target instanceof EntityGhasther) && !(target instanceof EntityPortal) && !(target instanceof EntityWitherStorm) && !(target instanceof EntityWitherStormHead) && !(target instanceof EntityWitherStormTentacle) && !(target instanceof EntityWitherStormTentacleDevourer))
				{
					...
					if (target instanceof net.mrbt0907.ageofminecraft.entity.tier4.EntityEnderman || target instanceof net.minecraft.entity.monster.EntityEnderman)
					{
						...
						if (rand.nextInt(500) == 0)
							...
							else if (target instanceof net.mrbt0907.ageofminecraft.entity.tier4.EntityEnderman && ((net.mrbt0907.ageofminecraft.entity.tier4.EntityEnderman)target).getHeldBlockState() == null)
							{
								attackEntityFrom(DamageSource.causeMobDamage(target), 2500);
								((net.mrbt0907.ageofminecraft.entity.tier4.EntityEnderman)target).setHeldBlockState(Blocks.OBSIDIAN.getDefaultState());
							}
					}
						...
						for (int i1 = 0; i1 < list1111.size(); i1++)
						{
							...
							if ((entity1 != null) && (entity1.isEntityAlive()) && ((!isOnSameTeam(entity1)) || ((entity1 instanceof EntityAnimal))) && (!(entity1 instanceof EntityFriendlyCreature)) && (!(entity1 instanceof EntityDragon)) && (!(entity1 instanceof EntityWitherStorm)) && (!(entity1 instanceof EntityWitherStormHead)) && (!(entity1 instanceof EntityWitherStormTentacle)) && (!(entity1 instanceof EntityWitherStormTentacleDevourer)))
							{
								...
								if (((entity1 instanceof net.minecraft.entity.monster.EntityEnderman)) || (target instanceof EntityFriendlyCreature && ((target instanceof EntityWitherStorm) || (target instanceof EntityWither) || (target instanceof EntityEnderDragon) || !((EntityFriendlyCreature)target).isNonBoss() || ((EntityFriendlyCreature)target).isHero())))
								{
									...
									if (rand.nextInt(500) == 0 && (((entity1 instanceof net.mrbt0907.ageofminecraft.entity.tier4.EntityEnderman)) || ((entity1 instanceof net.minecraft.entity.monster.EntityEnderman))))
									{
				...
				if ((list11111 != null) && (!list11111.isEmpty()))
				{
					for (int i1 = 0; i1 < list11111.size(); i1++)
					{
						...
						if ((residentWitherStorm == null) && (entity1 != null) && (entity1.isEntityAlive()) && ((!isOnSameTeam(entity1)) || ((entity1 instanceof EntityAnimal))) && (!(target instanceof net.mrbt0907.ageofminecraft.entity.tier4.EntityEnderman)) && (!(target instanceof net.minecraft.entity.monster.EntityEnderman)) && (!(entity1 instanceof EntityFriendlyCreature)) && (!(entity1 instanceof EntityWitherStorm)) && (!(entity1 instanceof EntityWitherStormHead)) && (!(entity1 instanceof EntityWitherStormTentacle)) && (!(entity1 instanceof EntityWitherStormTentacleDevourer)))
						{
