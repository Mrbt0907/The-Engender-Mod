...
public class EntityWitherStormTentacleDevourer extends EntityFriendlyCreature implements Massive, Armored, Flying, Undead
{
	...
	protected void applyEntityAttributes()
	{
		...
		getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).setBaseValue(400.0D);
	...
	public void onLivingUpdate()
	{
		...
		if (this.residentWitherStorm != null)
		{
			...
			if (this.residentWitherStorm.doesntContainACommandBlock())
			{
				...
				this.setLocationAndAngles(this.residentWitherStorm.posX, this.residentWitherStorm.posY + 10.0D, this.residentWitherStorm.posZ - oned, 0.0F, 0.0F);
			...
			{
				if (this.residentWitherStorm.tentacledevourer1 != null && this == this.residentWitherStorm.tentacledevourer1)
				this.setLocationAndAngles(this.residentWitherStorm.posX - twod * -12.0F, this.residentWitherStorm.posY + 10.0D, this.residentWitherStorm.posZ - oned * -12.0F, 0.0F, 0.0F);
				if (this.residentWitherStorm.tentacledevourer2 != null && this == this.residentWitherStorm.tentacledevourer2)
				this.setLocationAndAngles(this.residentWitherStorm.posX + twod * -12.0F, this.residentWitherStorm.posY + 10.0D, this.residentWitherStorm.posZ + oned * -12.0F, 0.0F, 0.0F);
			}
		}
