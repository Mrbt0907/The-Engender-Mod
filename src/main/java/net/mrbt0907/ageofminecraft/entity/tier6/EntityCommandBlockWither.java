...
implements IRangedAttackMob, Massive, Armored, Flying, Undead
{
	...
	*/
	...
	public void onLivingUpdate()
	{
		...
		if ((entity != null) && this.getSize() >= 6000 && !this.isOnSameTeam(entity) && (entity.getHealth() > 0.0F) && (!(entity instanceof EntityWitherStorm)) && (!(entity instanceof EntityWitherStormHead)) && (!(entity instanceof EntityWitherStormTentacle)) && (!(entity instanceof EntityWitherStormTentacleDevourer)))
		{
			...
			double d21 = this.posZ - entity.posZ;
			float f2 = MathHelper.sqrt(d01 * d01 + d11 * d11 + d21 * d21);
			if (entity instanceof net.mrbt0907.ageofminecraft.entity.tier4.EntityEnderman || entity instanceof net.minecraft.entity.monster.EntityEnderman)
			{
			...
			if ((list11111 != null) && (!list11111.isEmpty()) && this.getSize() >= 6000)
			{
				for (int i1 = 0; i1 < list11111.size(); i1++)
				{
					...
					if ((entity1 != null) && (entity1.isEntityAlive()) && ((!isOnSameTeam(entity1)) || ((entity1 instanceof EntityAnimal))) && (!(entity instanceof net.mrbt0907.ageofminecraft.entity.tier4.EntityEnderman)) && (!(entity instanceof net.minecraft.entity.monster.EntityEnderman)) && (!(entity1 instanceof EntityFriendlyCreature)) && (!(entity1 instanceof EntityDragon)) && (!(entity1 instanceof EntityWitherStorm)) && (!(entity1 instanceof EntityWitherStormHead)) && (!(entity1 instanceof EntityWitherStormTentacle)) && (!(entity1 instanceof EntityWitherStormTentacleDevourer)))
					{
