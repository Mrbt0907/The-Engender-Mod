...
import net.mrbt0907.ageofminecraft.entity.tier3.EntityTippedArrowOther;
...
public class EntityWitherStorm extends EntityFriendlyCreature implements Massive, Armored, Flying, Undead
{
	...
	*/
	...
	public String getName()
	{
    	...
    	return color + (hasCustomName() ? getCustomNameTag() : (this.doesntContainACommandBlock() ? "Severed Wither Storm" : "The Wither Storm")) + TextFormatting.WHITE;
	}
