 ...
 * - Polymorph System
 */
public abstract class EntityEngendered extends EntityCreature
{
	...
	public static final IAttribute VIGOR = new RangedAttribute((IAttribute)null, "engender.vigor", 0.0D, 0.0D, Double.MAX_VALUE).setDescription("Mob Vigor").setShouldWatch(true);
	public static final IAttribute STRENGTH = new RangedAttribute((IAttribute)null, "engender.strength", 0.0D, 0.0D, Double.MAX_VALUE).setDescription("Mob Strength").setShouldWatch(true);
	public static final IAttribute STAMINA = new RangedAttribute((IAttribute)null, "engender.stamina", 0.0D, 0.0D, Double.MAX_VALUE).setDescription("Mob Stamina").setShouldWatch(true);
	public static final IAttribute INTELLIGENCE = new RangedAttribute((IAttribute)null, "engender.intelligence", 0.0D, 0.0D, Double.MAX_VALUE).setDescription("Mob Intelligence").setShouldWatch(true);
	public static final IAttribute DEXTERITY = new RangedAttribute((IAttribute)null, "engender.dexterity", 0.0D, 0.0D, Double.MAX_VALUE).setDescription("Mob Dexterity").setShouldWatch(true);
	public static final IAttribute AGILITY = new RangedAttribute((IAttribute)null, "engender.agility", 0.0D, 0.0D, Double.MAX_VALUE).setDescription("Mob Agility").setShouldWatch(true);
	...
	public void onLivingUpdate()
	{
		...
		if (!world.isRemote && getNavigator().noPath() && hasOwner() && ticksExisted % 100 == 0)
			EngenderMod.info("Tried to find path but unable to (A:"+(owner == null ? false : getNavigator().getPathToEntityLiving(owner))+", B:"+(getNavigator().getPathSearchRange())+", C:"+(getNavigator().getNodeProcessor().getCanSwim())+")");
	}
    ...
    {
		return new EngenderedPathNavigator(this, world);
    }
