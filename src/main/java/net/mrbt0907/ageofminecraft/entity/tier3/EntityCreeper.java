...
import net.mrbt0907.ageofminecraft.entity.ai.EntityAICreeperSwell;
...
extends EntityFriendlyCreature implements Light
{
	...
	public EntityCreeper(World worldIn)
	{
		...
		this.tasks.addTask(0, new EntityAIAvoidEntitySPC(this, EntityOcelot.class, new Predicate<EntityOcelot>()
		{
			...
			this.tasks.addTask(0, new EntityAIAvoidEntitySPC(this, net.mrbt0907.ageofminecraft.entity.tier1.EntityOcelot.class, new Predicate<net.mrbt0907.ageofminecraft.entity.tier1.EntityOcelot>()
			{
				public boolean apply(net.mrbt0907.ageofminecraft.entity.tier1.EntityOcelot p_apply_1_)
				{
					return (p_apply_1_ != null) && p_apply_1_.isEntityAlive() && EntityCreeper.this.getIntelligence() < 10F;
				}
			}, 6.0F, 1.0D, 1.2D));
