	...
	public void updateRidden()
	{
		...
		*/
		...
		public void onKillEntity(EntityLivingBase entityLivingIn)
		{
			...
			if ((entityLivingIn instanceof net.mrbt0907.ageofminecraft.entity.tier2.EntityVillager))
			{
				net.mrbt0907.ageofminecraft.entity.tier2.EntityVillager entityvillager = (net.mrbt0907.ageofminecraft.entity.tier2.EntityVillager)entityLivingIn;
				EntityZombie entityzombie = new EntityZombie(this.world);
				entityzombie.rotationPitch = entityvillager.rotationPitch;
				entityzombie.renderYawOffset = entityzombie.rotationYaw = entityzombie.rotationYawHead = entityvillager.rotationYawHead;
				entityzombie.copyLocationAndAnglesFrom(entityLivingIn);
