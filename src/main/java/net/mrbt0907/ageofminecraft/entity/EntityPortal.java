...
import net.mrbt0907.ageofminecraft.entity.tier1.EntityParrot;
...
import net.mrbt0907.ageofminecraft.entity.tier2.EntitySnowman;
...
import net.mrbt0907.ageofminecraft.entity.tier4.EntityBlaze;
import net.mrbt0907.ageofminecraft.entity.tier4.EntityCaveSpider;
...
import net.mrbt0907.ageofminecraft.entity.tier4.EntityShulker;
...
import net.mrbt0907.ageofminecraft.entity.tier5.EntityElderGuardian;
import net.mrbt0907.ageofminecraft.entity.tier5.EntityEvoker;
import net.mrbt0907.ageofminecraft.entity.tier5.EntityIllusioner;
...
if ((this.ticksExisted + this.getEntityId()) > 60 && ((this.ticksExisted + this.getEntityId()) % (this.getJukeboxToDanceTo() != null ? 20 : (this.getMetaData() > 2 ? 50 : 100)) == 0) && (this.rand.nextInt((this.getJukeboxToDanceTo() != null ? 5 : 10)) == 0))
{
	...
	switch (i)
	{
		...
		{
			case 0:net.mrbt0907.ageofminecraft.entity.tier1.EntityBat bat = new net.mrbt0907.ageofminecraft.entity.tier1.EntityBat(this.world);
			...
			break;
			case 5:net.mrbt0907.ageofminecraft.entity.tier1.EntityPig pig = new net.mrbt0907.ageofminecraft.entity.tier1.EntityPig(this.world);
			...
			case 1:switch (this.rand.nextInt(7))
			{
				...
				break;
				case 1:net.mrbt0907.ageofminecraft.entity.tier2.EntitySilverfish silverfish = new net.mrbt0907.ageofminecraft.entity.tier2.EntitySilverfish(this.world);
				...
				{
					case 0:net.mrbt0907.ageofminecraft.entity.tier3.EntityCreeper creeper = new net.mrbt0907.ageofminecraft.entity.tier3.EntityCreeper(this.world);
					...
					break;
					case 1:net.mrbt0907.ageofminecraft.entity.tier3.EntityMagmaCube magmacube = new net.mrbt0907.ageofminecraft.entity.tier3.EntityMagmaCube(this.world);
					...
					break;
					case 3:net.mrbt0907.ageofminecraft.entity.tier3.EntitySlime slime = new net.mrbt0907.ageofminecraft.entity.tier3.EntitySlime(this.world);
					...
					case 3:switch (this.rand.nextInt(12))
					{
						...
						break;
						case 2:net.mrbt0907.ageofminecraft.entity.tier4.EntityEnderman enderman = new net.mrbt0907.ageofminecraft.entity.tier4.EntityEnderman(this.world);
						...
						case 4:switch (this.rand.nextInt(6))
						{
							...
							break;
							case 1:net.mrbt0907.ageofminecraft.entity.tier5.EntityGiant giant = new net.mrbt0907.ageofminecraft.entity.tier5.EntityGiant(this.world);
							...
							break;
							case 2:net.mrbt0907.ageofminecraft.entity.tier5.EntityIronGolem irongolem = new net.mrbt0907.ageofminecraft.entity.tier5.EntityIronGolem(this.world);
							...
							break;
							case 3:net.mrbt0907.ageofminecraft.entity.tier5.EntityWither wither = new net.mrbt0907.ageofminecraft.entity.tier5.EntityWither(this.world);
