...
import net.mrbt0907.ageofminecraft.EngenderCompat;
import net.mrbt0907.ageofminecraft.EngenderConfig;
import net.mrbt0907.ageofminecraft.EngenderMod;
import net.mrbt0907.ageofminecraft.blocks.BlockGuardBlock;
import net.mrbt0907.ageofminecraft.effects.EngenderExplosion;
import net.mrbt0907.ageofminecraft.entity.ai.EntityAIAvoidEntitySPC;
import net.mrbt0907.ageofminecraft.entity.ai.EntityAIFindNearestUnalliedTarget;
import net.mrbt0907.ageofminecraft.entity.ai.EntityAIFollowWildAdult;
import net.mrbt0907.ageofminecraft.entity.ai.EntityAIFriendlyHurtByTarget;
import net.mrbt0907.ageofminecraft.entity.ai.EntityAILeaderHurtByTarget;
import net.mrbt0907.ageofminecraft.entity.ai.EntityAILeaderHurtTarget;
import net.mrbt0907.ageofminecraft.entity.other.AttributeModifierEX;
...
import net.mrbt0907.ageofminecraft.entity.tier3.EntityVex;
import net.mrbt0907.ageofminecraft.entity.tier4.EntityEnderman;
...
import net.mrbt0907.ageofminecraft.entity.tier5.EntityEnderDragon;
import net.mrbt0907.ageofminecraft.entity.tier5.EntityEvoker;
import net.mrbt0907.ageofminecraft.entity.tier5.EntityWither;
import net.mrbt0907.ageofminecraft.entity.tier6.EntityWitherStorm;
import net.mrbt0907.ageofminecraft.entity.tier6.EntityWitherStormHead;
import net.mrbt0907.ageofminecraft.entity.tier6.EntityWitherStormTentacle;
import net.mrbt0907.ageofminecraft.entity.tier6.EntityWitherStormTentacleDevourer;
import net.mrbt0907.ageofminecraft.items.ItemEngenderStatChecker;
import net.mrbt0907.ageofminecraft.items.ItemLearningBook;
...
public abstract class EntityFriendlyCreature extends EntityCreature implements IEntityOwnable, ITeamedMobs
{
	...
	public void onUpdateServer()
	{
		...
		if (mainItem != null)
		{
			if (mainItem instanceof ItemLearningBook)
			{
				...
				{
					setSitResting(true);
					rotationPitch = this instanceof net.mrbt0907.ageofminecraft.entity.tier4.EntityShulker || this instanceof EntityGuardian ? 0F : 30F;
	...
	{
	if (getTier().ordinal() > EnumTier.TIER5.ordinal() || this instanceof net.mrbt0907.ageofminecraft.entity.tier3.EntityVex || this instanceof net.mrbt0907.ageofminecraft.entity.tier4.EntityShulker || this instanceof EntityWither)
	++deathTime;
	else
	deathTime = 0;
	}
	...
	*/
	...
	if (this instanceof net.mrbt0907.ageofminecraft.entity.tier4.EntityEnderman && ((net.mrbt0907.ageofminecraft.entity.tier4.EntityEnderman)this).andr)
	{
	i += 60;
	f *= 10000F;
	if ((entity instanceof EntityLivingBase))
	...
	if (this instanceof net.mrbt0907.ageofminecraft.entity.tier4.EntityGhast && ((net.mrbt0907.ageofminecraft.entity.tier4.EntityGhast)this).eleanor)
	{
	i += 30;
	f *= 1000F;
	if ((entity instanceof EntityLivingBase))
	...
	if ((this instanceof net.mrbt0907.ageofminecraft.entity.tier4.EntityGuardian || !isNonBoss()) && (itemstack1 != null && itemstack1.getItem() == Items.SHIELD))
	{
	...
	if (this instanceof net.mrbt0907.ageofminecraft.entity.tier3.EntityVex)
	{
	((net.mrbt0907.ageofminecraft.entity.tier3.EntityVex)this).setIsCharging(false);
	}
	...
	{
	if (this instanceof net.mrbt0907.ageofminecraft.entity.tier3.EntityVex || this instanceof net.mrbt0907.ageofminecraft.entity.tier4.EntityGhast)
	getMoveHelper().setMoveTo(i3, k, l, 1D);
	else
	getNavigator().tryMoveToXYZ(i3, k, l, 1D);
	if (this instanceof net.mrbt0907.ageofminecraft.entity.tier4.EntityGuardian || this instanceof net.mrbt0907.ageofminecraft.entity.tier4.EntityShulker || this instanceof net.mrbt0907.ageofminecraft.entity.tier4.EntityGhast || getDistanceSqToCenter(blockpos) < 4D)
	{
	if (block instanceof BlockEndPortal && !isNonBoss())
	changeDimension(1);
	
	setPositionAndUpdate(i3 + 0.5, k, l + 0.5);
	if (this instanceof net.mrbt0907.ageofminecraft.entity.tier4.EntityShulker)
