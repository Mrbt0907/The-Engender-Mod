...
public class EntityIronGolem extends EntityFriendlyCreature implements Armored
{
	...
	*/
	...
	public boolean attackEntityAsMob(Entity entityIn)
	{
		...
		{
			this.setHoldingRose(true);
			net.mrbt0907.ageofminecraft.entity.tier2.EntityVillager entityvillager = new net.mrbt0907.ageofminecraft.entity.tier2.EntityVillager(this.world);
		...
		if (entityIn instanceof net.mrbt0907.ageofminecraft.entity.tier2.EntityVillager && !this.isWild() && !this.isOnSameTeam((net.mrbt0907.ageofminecraft.entity.tier2.EntityVillager)entityIn))
		{
			this.setHoldingRose(true);
			((net.mrbt0907.ageofminecraft.entity.tier2.EntityVillager)entityIn).setOwnerId(this.getOwnerId());
