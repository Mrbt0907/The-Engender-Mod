...
import net.mrbt0907.ageofminecraft.entity.EntitySpellcasterIllager;
...
import net.mrbt0907.ageofminecraft.entity.tier4.EntityLargeFireballOther;
import net.mrbt0907.ageofminecraft.entity.tier4.EntitySmallFireballOther;
						...
						*/
						...
						protected void castSpell()
						{
							...
							if (entitysheep != null && entitysheep.isEntityAlive() && EntityEvoker.this.isOnSameTeam(entitysheep))
							{
								...
								{
									if (entitysheep instanceof net.mrbt0907.ageofminecraft.entity.tier1.EntitySheep)
