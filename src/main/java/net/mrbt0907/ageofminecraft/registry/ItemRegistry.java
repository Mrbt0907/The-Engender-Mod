...
import net.mrbt0907.ageofminecraft.entity.tier3.EntityMagmaCube;
...
import net.mrbt0907.ageofminecraft.entity.tier6.EntityCommandBlockWither;
import net.mrbt0907.ageofminecraft.items.*;
...
public class ItemRegistry
{
	...
	public static void addEngenderedEntity(Class<? extends EntityEngendered> entityClass, int tier, int mana, int entropy, int fusionTime)
	{
		addEngenderedEntity(entityClass, tier, mana, entropy, fusionTime, SpawnerRegistry.SPAWN_NORMAL, null);
	}
	
	public static void addEngenderedEntity(Class<? extends EntityEngendered> entityClass, int tier, int mana, int entropy, int fusionTime, BiConsumer<EntityPlayer, Object[]> spawnMechanics)
	{
		addEngenderedEntity(entityClass, tier, mana, entropy, fusionTime, spawnMechanics, null);
	}
	
	public static void addEngenderedEntity(Class<? extends EntityEngendered> entityClass, int tier, int mana, int entropy, int fusionTime, Consumer<EntityEngendered> spawnMechanicsPost)
	{
		addEngenderedEntity(entityClass, tier, mana, entropy, fusionTime, SpawnerRegistry.SPAWN_NORMAL, spawnMechanicsPost);
	}
	
	public static void addEngenderedEntity(Class<? extends EntityEngendered> entityClass, int tier, int mana, int entropy, int fusionTime, BiConsumer<EntityPlayer, Object[]> spawnMechanics, Consumer<EntityEngendered> spawnMechanicsPost)
	{
	...
	public static void addEngenderedEntity(Class<? extends EntityEngendered> entityClass, String entityName, int tier, int mana, int entropy, int fusionTime, BiConsumer<EntityPlayer, Object[]> spawnMechanics, Consumer<EntityEngendered> spawnMechanicsPost)
	{
		EntityEntry registryName = net.minecraftforge.fml.common.registry.EntityRegistry.getEntry(entityClass);
		if (registryName == null)
		{
