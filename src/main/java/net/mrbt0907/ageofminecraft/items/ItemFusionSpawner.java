...
public class ItemFusionSpawner extends Item
{
	...
	protected final Class<? extends EntityEngendered> entityClass;
	protected final BiConsumer<EntityPlayer, Object[]> spawnMechanics;
	protected final Consumer<EntityEngendered> spawnMechanicsPost;
	
	public ItemFusionSpawner(Class<? extends EntityEngendered> entityClass, int tier, BiConsumer<EntityPlayer, Object[]> spawnMechanics, Consumer<EntityEngendered> spawnMechanicsPost)
	{
	...
	public ItemFusionSpawner(Class<? extends EntityEngendered> entityClass, int tier, BiConsumer<EntityPlayer, Object[]> spawnMechanics)
	{
